...
function BlockLine({ block, editable, isSelected, endState, onFieldChange, onFieldBlur, onInputKeyDown }: Props) {
  ...
  return (
    <div className="block-line">
      ...
      {isSelected && endState && (
        <div className="block-end-state">
          <span className="block-end-state-coord">
            XYZ({endState.position.x}, {endState.position.y}, {endState.position.z})
          </span>
          <span className="block-end-state-orientation">朝向{endState.orientation}°</span>
          <span className="block-end-state-lights">
            {endState.lights.map((color, idx) => (
              <span
                key={idx}
                className="block-end-state-light-dot"
