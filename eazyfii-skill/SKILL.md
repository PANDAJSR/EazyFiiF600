...
3. **先参考科目示例**：涉及到科目完成时，务必先参考对应科目的示例文档（科目1参考 [subject1-example.md](./subject1-example.md)，科目2参考 [subject2-example.md](./subject2-example.md)），了解坐标设置、转向逻辑、延时要求等关键细节。注意示例仅供参考，实际坐标需根据现场情况调整
